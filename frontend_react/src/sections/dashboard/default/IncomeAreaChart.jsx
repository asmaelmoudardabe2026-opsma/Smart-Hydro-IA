...
// 🎨 Trjma dyal les labels l l-Français
...
export default function IncomeAreaChart({ view }) {
  ...
  // 🎨 Trjma dyal l-état initial dyal l-visibility
  ...
  const visibleSeries = [
    {
      data: data1,
      label: 'Pages vues', // ➔ Trjma hna
      showMark: false,
      area: true,
      id: 'page-views',
      color: theme.vars.palette.primary.main || '',
      visible: visibility['Pages vues']
    },
    {
      data: data2,
      label: 'Sessions', // ➔ Tat-b9a direct s7ī7a b l-Français
      showMark: false,
      area: true,
      id: 'sessions',
